...
class ProductController extends Controller
{
            ...
            if ($variations != null && count($variations) > 0) {
                ...
                foreach ($variations as $variation) {
                    ...
                    if ($old_variation){
                        ...
                        $old_price = ProductVariationPrice::query()->where('product_id', $product_id)->where('variaiton_id', $old_variation->id)->first();
    ...
    public function getProductById($product_id)
    {
        try {
            ...
            if($product->owner_id == $shop->id && $product->owner_type == 1) {
            ...
            if ($exception->getMessage() == 'shop-005'){
                return  response(['message' => 'Bu ürüne erişim yetkiniz bulunmamaktadır.','status' => 'shop-005']);
            }
