...
use App\Http\Controllers\Api\Shop\AdminUserComments;
use App\Http\Controllers\Api\Shop\AdminRoleController;
use App\Http\Controllers\Api\Shop\AdminPermissionController;
...
use App\Http\Controllers\Api\Shop\ImportController;
use App\Http\Controllers\Api\Shop\ShippingTypeController;
...
use App\Http\Controllers\Api\Shop\DeliveryController;
use App\Http\Controllers\Api\Shop\PopupController;
use App\Http\Controllers\Api\Shop\SubscribeController;
use App\Http\Controllers\Api\Shop\ProformaController;
...
Route::middleware(['auth:sanctum', 'type.shop'])->group(function (){
    ...
    Route::get('logout', [AuthController::class, 'logout'])->name('shop.logout');
    Route::post('register', [AuthController::class, 'register'])->name('shop.register');
